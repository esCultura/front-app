...
export default function Categoria (props){
    ...
    const fetchEsdeveniments = async () =>{
        let endpoint = 'esdeveniments/?tematiques__nom__in='+props.tipus+'&limit=5'
    }
    ...
    renderBotoFollow =() =>{
        if(seguit){
            return(
             <View>
                 <TouchableOpacity style={styles.unfollow}onPress={deixarDeSeguir}>
             ...
             return(
                 <View>
                     <TouchableOpacity style={styles.follow}onPress={seguir}>
                     <Text>seguir</Text>
                     </TouchableOpacity>
    ...
    return(
        <View>
            <TouchableOpacity onPress={recarrega}>
        ...
        <Modal visible={modalVisible}>
            <View style={styles.top}>
                ...
                <Text style={styles.titol}>Categoria</Text>
            </View>
            <View style={styles.nomCategoria}>
                <Text style={styles.text}>{props.tipus}</Text>
            </View>
            <View>
               {renderBotoFollow()}
            </View>
